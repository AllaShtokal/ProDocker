...
public class StationElasticControler {
    ...
    public StationElasticControler(ElasticSearchStationRepository elasticSearchStationRepository, StationDtoElasticSearchService stationDtoElasticSearchService) {
